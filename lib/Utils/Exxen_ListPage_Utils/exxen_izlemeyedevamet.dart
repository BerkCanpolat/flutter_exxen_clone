...
class Exxen_Izlemeye_Devam_et extends StatefulWidget {
  const Exxen_Izlemeye_Devam_et({super.key});

  @override
  State<Exxen_Izlemeye_Devam_et> createState() =>
      _Exxen_Izlemeye_Devam_etState();
}

class _Exxen_Izlemeye_Devam_etState extends State<Exxen_Izlemeye_Devam_et> {
  
  Future<List<ExxenListClass1>> ExxenclassList() async {
    var exxenListem = <ExxenListClass1>[];

    var l1 = ExxenListClass1("katarsiz.webp", "Katarsis");
    var l2 = ExxenListClass1("garaj.webp", "Garaj Exxen");
    var l3 = ExxenListClass1("nolimit.webp", "No Limit");
    var l4 = ExxenListClass1("oadam.webp", "O Adam Oldun Mu?");
    var l5 = ExxenListClass1("tasarimevler.webp", "Tasarım Evler");
